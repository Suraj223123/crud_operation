						...
						<div class="card" style="border-radius: 15px;">
							<div class="card-body p-5">
								...
								try {
									...
									String sql = "SELECT * FROM `today_work` WHERE id = '" + id + "'  ";
								...
								<form action="update" method="post">
									...
									<div class="form-outline mb-4">
                                         <input type="hidden" name="id"
											value="<%out.println(rs.getString("id"));%>  "
											  />
                                         
										<input type="text" name="name"
											value="<%out.println(rs.getString("name"));%>"
									...
									<div class="form-outline mb-4">
										<input type="password" name="password"
											value="<%out.println(rs.getString("password"));%> "
									...
									<div class="d-flex justify-content-center">
										<button type="submit" 
											class="btn btn-success btn-block btn-lg gradient-custom-4 text-body">Upate</button>
									</div>
								</form>
								<%
								}
